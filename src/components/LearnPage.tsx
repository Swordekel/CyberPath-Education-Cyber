import { BookOpen, Lock, Shield, Code, Network, Eye, CheckCircle, Clock, Play, Star } from 'lucide-react';
...
export function LearnPage({ isLoggedIn, onNavigate }: LearnPageProps) {
